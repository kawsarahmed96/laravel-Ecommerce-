    ...
    <div class="col-xl-8">
        ...
        <div class="card-body py-3">
            <div class="table-responsive">
                <table class="table-row-dashed table-row-gray-300 gs-0 gy-4 table align-middle" id="colorDatatable">
                    <thead>
                    ...
                    <tbody>
                        @foreach ($banners as $banner)
                            <tr>
                                ...
                                <td>{{ $banner->image }}</td>
                                <td>{{ $banner->status }}</td>
                                <td>{{ $banner->created_at->format('d Y M') }}</td>
                                <td>
        ...
        <div class="col-xl-4">
            <div class="card card-xl-stretch mb-xl-8 mb-5">
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Create Banner</span>
                    </h3>
                </div>
                <div class="card-body py-3">
                    <form action="{{ route('backend.productmanagement.Banner.store') }}" enctype="multipart/form-data"
                        method="POST">
                        @csrf
                        <div class="fv-row fv-plugins-icon-container mb-9">
                            <label class="fs-6 fw-bold mb-2">Title <span class="text-danger">*</span></label>
                            <input class="form-control form-control-solid" name="title" type="text">
                            @error('title')
                        ...
                        <div class="fv-row fv-plugins-icon-container mb-9">
                            ...
                            <input class="form-control form-control-solid" name="short_description" type="text">
                            @error('short_description')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>

                        <div class="fv-row fv-plugins-icon-container col-md-6 mb-9">
                            <label class="fs-6 fw-bold mb-2">Price</label>
                            <input class="form-control form-control-solid" name="price" type="number">
                            @error('price')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="fv-row fv-plugins-icon-container col-md-6 mb-9">
                            ...
                            <input class="form-control form-control-solid" name="sale_price" type="number">
                            @error('sale_price')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
