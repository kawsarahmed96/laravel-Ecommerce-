            ...
            <div class="card card-xl-stretch mb-5 mb-xl-12">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="btn btn-sm bg-primary text-white  me-5 rounded-pill">Product List</span>

                    </h3>
                    <div data-bs-trigger="hover">
                        <a href="{{ route('backend.productmanagement.product.trash.list') }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-end flex-shrink-0">
                                                ...
                                                <a href="{{ route('backend.productmanagement.Inventory.index', ['product_id' => $product->id]) }}"
                                                    class="btn btn-sm bg-primary text-white  me-5 rounded-pill">
                                                    Add store
                                                </a>
                                                ...
                                                <a href="{{ route('backend.productmanagement.Product.edit', $product->id) }}"
                                                    class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                ...
                                                @can('delete role')
                                                    <form
                                                        action="{{ route('backend.productmanagement.Product.destroy', $product->id) }}"
                                                        method="post">
                                                        @method('delete')
                                                        @csrf
                                                        ...
                                                        <button
                                                            class="border-0 btn-icon btn-bg-light btn-active-color-primary btn-sm"
                                                            type="submit">
                                                            <a><span class="svg-icon svg-icon-3">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                        height="24" viewBox="0 0 24 24" fill="none">
                                                                        <path
                                                            ...
                                                            </a><!--begin::Svg Icon | path: icons/duotune/general/gen027.svg-->
                                                        </button>
