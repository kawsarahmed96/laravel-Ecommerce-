    ...
    <div class="col-xl-8">
        ...
        <div class="col-xl-4">
            <div class="card card-xl-stretch mb-xl-8 mb-5">
                ...
                <div class="card-body py-3">
                    <form action="{{ route('backend.productmanagement.Promotion.store') }}" enctype="multipart/form-data"
                        method="POST">
                        @csrf
                        ...
                        <div class="fv-row fv-plugins-icon-container mb-9">
                            <label class="fs-6 fw-bold mb-2">Button<span class="text-danger">*</span></label>
                            <input class="form-control form-control-solid" name="button" type="text">
                            @error('button')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
