    ...
    <div class="row gy-5 g-xl-8">
                            ...
                            <tbody>
                                @foreach ($permissions as $permission)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="d-flex justify-content-start flex-column">
                                                    <a href="#"
                                                        class="text-dark fw-bolder text-hover-primary fs-6">{{ $permission->name }}</a>
                                        ...
                                        <td>
                                            <a href="#"
                                                class="text-dark fw-bolder text-hover-primary d-block fs-6">{{ $permission->created_at }}</a>
        ...
        <div class="col-xl-4">
            ...
            <div class="card card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Add Permission </span>
