    ...
    <div class="row gy-5 g-xl-12">
            ...
            <div class="card card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Size List</span>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-end flex-shrink-0">
                                                   ...
                                                   <a href="{{ route('backend.productmanagement.Size.show', $size->id) }}"
                                                ...
                                                <form action="" method="post">
                                                    ...
                                                    <a href="{{ route('backend.productmanagement.Size.edit', $size->id) }}"
                                                        class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                        @csrf
                                                        @method('put')
                                                ...
                                                @can('delete size')
                                                    <form
                                                        action="{{ route('backend.productmanagement.Size.destroy', $size->id) }}"
                                                        method="post">
                                                        @csrf
                                                        @method('delete')
        ...
        <div class="col-xl-4">
            ...
            <div class="card card-xl-stretch mb-5 mb-xl-8">
                ...
                <div class="card-header border-0 pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder fs-3 mb-1">Create Size </span>
                ...
                <div class="card-body py-3">
                    ...
                    <div class="table-responsive">
                        <!--begin::Table-->
                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                            <form action="{{ route('backend.productmanagement.Size.store') }}" method="post">
                                @csrf
