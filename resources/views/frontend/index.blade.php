                ...
                <div class="col-lg-9 offset-lg-3">
                    <div class="main_slider" data-slick='{"arrows": false}'>
                        ...
                        @foreach ($banners as $banner)
                            <div class="slider_item set-bg-image" data-background="{{ 'storage/banner/' . $banner->image }}">
                                <div class="slider_content">
                                    ...
                                    <a class="btn btn_primary" data-animation="fadeInUp2" data-delay=".8s"
                                        href="shop_details.html">Start Buying</a>
                                </div>
                            </div>
                        @endforeach
                ...
                <div class="col-lg-9 order-lg-3">
                    <div class="best-selling-products">
                        ...
                        <div class="product-area clearfix">
                            ...
                            @foreach ($topProducts as $topProduct)
                                {{-- {{ $bestSellProduct->galleries}} --}}
                                <div class="grid">
                                    <div class="product-pic">
                                        {{-- <img src={{ asset("$topProducts->galleries()->image_path")}} alt="{{ $topProducts->title }}"> --}}
                                        <div class="actions">
                                            <ul>
                                                <li>
                                    ...
                                    <div class="details">
                                        <h4><a href="#">{{ $topProduct->title }}</a></h4>
                                        <p><a href="#">{{ $topProduct->short_description }}
                                            </a></p>
                                        <div class="rating">
                                        ...
                                        <span class="price">
                                            <ins>
                                                <span class="woocommerce-Price-amount amount">
                                                    <bdi>
                                                        <span
                                                            class="woocommerce-Price-currencySymbol">$</span>{{ $topProduct->sale_price }}
                                                    </bdi>
                                                </span>
                                            </ins>
                                        </span>
                    ...
                    <div class="top_category_wrap">
                        ...
                        <div class="carousel_nav carousel-nav-top-right">
                            <button class="tc_left_arrow" type="button"><i
                                    class="fal fa-long-arrow-alt-left"></i></button>
                            <button class="tc_right_arrow" type="button"><i
                        ...
                        <div class="widget latest_product_carousel">
                            <div class="title_wrap">
                                ...
                                <div class="carousel_nav">
                                    <button class="vs4i_left_arrow" type="button"><i
                                            class="fal fa-angle-left"></i></button>
                                    <button class="vs4i_right_arrow" type="button"><i
                                    ...
                                    <div class="slider_item">
                                        <div class="small_product_layout">
                                            <a class="item_image" href="shop_details.html">
                                                <img src=" {{ 'storage/products/' . $latest->image }}"
                                                    alt="image_not_found">
                                            </a>

                                            <div class="item_content">
                                                <h3 class="item_title">
                                                    <a href="shop_details.html">{{ $latest->title }}</a>
                                                </h3>
                    ...
                    <div class="col col-lg-6">
                        ...
                        <div class="promotion_banner">
                            <div class="item_image">
                                <img src="{{ 'storage/promotion/' . $promotion->image }}" alt>
                            </div>
                            <div class="item_content">
                                <h3 class="item_title"><span>{{ $promotion->title }}</span></h3>
                                <p>{{ $promotion->short_description }}</p>
                                <a class="btn btn_primary" href="shop_details.html">{{ $promotion->button }}</a>
                            </div>
                        </div>
            ...
            <div class="row newarrivals_products">
                ...
                <div class="col col-lg-7">
                    <div class="new-arrivals-grids clearfix">
                        @foreach ($newArrivProducts as $newArrivProduct)
                            <div class="grid">
                                <div class="product-pic">
                                ...
                                <div class="details">
                                    <h4><a href="#">{{ $newArrivProduct->title }}</a></h4>
                                    <p><a href="#">{{ $newArrivProduct->short_description }}</a>
                                    </p>
                                    <span class="price">
                                        <ins>
                                            <span class="woocommerce-Price-amount amount">
    ...
    <section class="viewed_products_section section_space">
        <div class="container">
            ...
            <div class="viewed_products_wrap arrows_topright">
                ...
                <div class="carousel_nav">
                    <button class="vpc_left_arrow" type="button"><i class="fal fa-long-arrow-alt-left"></i></button>
                    <button class="vpc_right_arrow" type="button"><i class="fal fa-long-arrow-alt-right"></i></button>
                </div>
            </div>
        </div>
    </section>
