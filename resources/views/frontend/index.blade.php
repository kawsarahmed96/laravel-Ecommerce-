                ...
                <div class="col-lg-9 offset-lg-3">
                    <div class="main_slider" data-slick='{"arrows": false}'>
                        <div class="slider_item set-bg-image"
                            data-background="{{ asset('frontend/images/slider/slide-2.jpg') }}">
                        ...
                        <div class="slider_item set-bg-image"
                            data-background="{{ asset('frontend/images/slider/slide-3.jpg') }}">
                            <div class="slider_content">
                                <h3 class="small_title" data-animation="fadeInUp2" data-delay=".2s">Clothing
                                </h3>
                                <h4 class="big_title" data-animation="fadeInUp2" data-delay=".4s">Smart blood
                        ...
                        <div class="slider_item set-bg-image"
                            data-background="{{ asset('frontend/images/slider/slide-1.jpg') }}">
                            <div class="slider_content">
                                <h3 class="small_title" data-animation="fadeInUp2" data-delay=".2s">Clothing
                                </h3>
                                <h4 class="big_title" data-animation="fadeInUp2" data-delay=".4s">Smart blood
                        ...
                        <div class="product-area clearfix">
                            ...
                            <div class="grid">
                                ...
                                <div class="details">
                                    ...
                                    <p><a href="#">Apple Watch Series 7 case Pair any band with cool
                                            design</a></p>
                                    <div class="rating">
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                            ...
                            <div class="grid">
                                ...
                                <div class="details">
                                    ...
                                    <p><a href="#">The ultimate iPad experience all over the world with
                                            coll model </a></p>
                                    <div class="rating">
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
                            ...
                            <div class="grid">
                                ...
                                <div class="details">
                                    ...
                                    <p><a href="#">Apple iMac 29″ Laptop with new Touch bar ID for you
                                        </a></p>
                                    <div class="rating">
                                        <i class="fas fa-star"></i>
                                        <i class="fas fa-star"></i>
